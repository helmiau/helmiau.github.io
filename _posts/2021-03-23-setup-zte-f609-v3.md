...
- [Download this configuration](https://raw.githubusercontent.com/helmiau/openwrt-config/main/zte-f609-v3-conf/User%20Configuration%20with%20VLAN.bin) to make your router LAN 1 port for input connection (modem), and LAN 2 as connection port to OpenWrt (output). Follow import instructions above to apply this config to your router.
