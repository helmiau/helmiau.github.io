...
1. Download latest firmware from link above which contain **sysupgrade** or **factory** words. How about squashfs or ext4 ? [Read more here](https://forum.openwrt.org/t/ext4-vs-squashfs/25187/7). Note : I usually use factory_ext4 file. - If firmware URL/download link is not available or error, follow [this link](https://github.com/helmiau/OpenWrt-Rpi/discussions/18).
